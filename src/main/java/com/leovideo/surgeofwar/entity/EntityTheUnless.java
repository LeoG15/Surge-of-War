...
import com.leovideo.surgeofwar.item.ItemUnlessSword;
import com.leovideo.surgeofwar.ElementsSurgeofwarMod;

@ElementsSurgeofwarMod.ModElement.Tag
public class EntityTheUnless extends ElementsSurgeofwarMod.ModElement {
	public static final int ENTITYID = 42;
	public static final int ENTITYID_RANGED = 43;
	public EntityTheUnless(ElementsSurgeofwarMod instance) {
		super(instance, 171);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("surgeofwar", "the_unless"), ENTITYID)
						.name("the_unless").tracker(64, 3, true).egg(-3407872, -13421773).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("surgeofwar:textures/emperor_of_blade.png");
				}
			};
	...
	public static class EntityCustom extends EntityMob {
		public EntityCustom(World world) {
			...
			setNoAI(!true);
			this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(ItemUnlessSword.block, (int) (1)));
		}
		...
		protected Item getDropItem() {
			return new ItemStack(ItemUnlessSword.block, (int) (1)).getItem();
		}
		...
		protected void applyEntityAttributes() {
			...
			if (this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH) != null)
				this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(568D);
