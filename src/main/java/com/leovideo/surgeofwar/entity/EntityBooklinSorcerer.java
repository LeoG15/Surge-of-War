...
public class EntityBooklinSorcerer extends ElementsSurgeofwarMod.ModElement {
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("surgeofwar", "booklinsorcerer"), ENTITYID)
						.name("booklinsorcerer").tracker(64, 3, true).egg(-10400982, -1).build());
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("surgeofwar", "entitybulletbooklinsorcerer"), ENTITYID_RANGED).name("entitybulletbooklinsorcerer")
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("surgeofwar:textures/ook_uardian.png");
				}
			};
	...
	public static class EntityCustom extends EntityMob implements IRangedAttackMob {
		public EntityCustom(World world) {
			...
			setNoAI(!true);
			this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(Items.BOOK, (int) (1)));
		}
