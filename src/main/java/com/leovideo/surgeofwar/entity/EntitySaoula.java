...
public class EntitySaoula extends ElementsSurgeofwarMod.ModElement {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("surgeofwar:textures/saoulaa.png");
				}
			};
	...
	public static class EntityCustom extends EntityMob {
		public EntityCustom(World world) {
			...
			setNoAI(!true);
			this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(ItemSunSword.block, (int) (1)));
		}
		...
		protected Item getDropItem() {
			return new ItemStack(ItemSunPower.block, (int) (1)).getItem();
		}
