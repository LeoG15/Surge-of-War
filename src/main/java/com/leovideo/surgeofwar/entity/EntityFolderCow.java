...
public class EntityFolderCow extends ElementsSurgeofwarMod.ModElement {
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("surgeofwar", "foldercow"), ENTITYID)
						.name("foldercow").tracker(64, 3, true).egg(-5042160, -10876663).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("surgeofwar:viprinbiome")),};
		EntityRegistry.addSpawn(EntityCustom.class, 20, 2, 3, EnumCreatureType.CREATURE, spawnBiomes);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelCow(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("surgeofwar:textures/folder_cow.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityAnimal {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemFolderSteak.block, (int) (1)).getItem();
		}
