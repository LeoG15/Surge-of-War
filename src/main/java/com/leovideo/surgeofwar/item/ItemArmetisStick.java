...
import com.leovideo.surgeofwar.procedure.ProcedureArmetisStickRightClickedInAir;
...
public class ItemArmetisStick extends ElementsSurgeofwarMod.ModElement {
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
				...
				int z = (int) entity.posZ;
				{
					...
					ProcedureArmetisStickRightClickedInAir.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setUnlocalizedName("armetisstick").setRegistryName("armetisstick").setCreativeTab(TabItemOfWar.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("surgeofwar:armetisstick", "inventory"));
	}
