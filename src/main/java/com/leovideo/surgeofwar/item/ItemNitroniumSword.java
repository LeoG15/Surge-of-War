...
public class ItemNitroniumSword extends ElementsSurgeofWar.ModElement {
	...
	public void initElements() {
		elements.items.add(() -> new ItemSword(EnumHelper.addToolMaterial("NITRONIUMSWORD", 1, 4000, 4f, 8f, 2)) {
			@Override
		...
		}.setUnlocalizedName("nitroniumsword").setRegistryName("nitroniumsword").setCreativeTab(TabItemOfWar.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("surgeofwar:nitroniumsword", "inventory"));
	}
}
