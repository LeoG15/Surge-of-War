...
import com.leovideo.surgeofwar.procedure.ProcedureEmeraldStickRightClickedInAir;
...
public class ItemEmeraldStick extends ElementsSurgeofwarMod.ModElement {
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
				...
				int z = (int) entity.posZ;
				{
					...
					ProcedureEmeraldStickRightClickedInAir.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setUnlocalizedName("emeraldstick").setRegistryName("emeraldstick").setCreativeTab(TabItemOfWar.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("surgeofwar:emeraldstick", "inventory"));
	}
