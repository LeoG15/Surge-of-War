...
public class ItemAmethisteAxe extends ElementsSurgeofwarMod.ModElement {
	...
	public void initElements() {
		...
		}.setUnlocalizedName("amethisteaxe").setRegistryName("amethisteaxe").setCreativeTab(TabItemOfWar.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("surgeofwar:amethisteaxe", "inventory"));
	}
	private static class ItemToolCustom extends ItemTool {
		...
		protected ItemToolCustom() {
			super(EnumHelper.addToolMaterial("AMETHISTEAXE", 2, 300, 6f, 6f, 2), effective_items_set);
