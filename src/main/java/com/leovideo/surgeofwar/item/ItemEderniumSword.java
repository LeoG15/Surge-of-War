...
public class ItemEderniumSword extends ElementsSurgeofwarMod.ModElement {
	...
	public void initElements() {
		elements.items.add(() -> new ItemSword(EnumHelper.addToolMaterial("EDERNIUMSWORD", 1, 10000, 4f, 18f, 2)) {
			@Override
		...
		}.setUnlocalizedName("ederniumsword").setRegistryName("ederniumsword").setCreativeTab(TabItemOfWar.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("surgeofwar:ederniumsword", "inventory"));
	}
}
