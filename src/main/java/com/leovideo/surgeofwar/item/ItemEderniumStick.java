...
import com.leovideo.surgeofwar.procedure.ProcedureEderniumStickRightClickedInAir;
...
public class ItemEderniumStick extends ElementsSurgeofwarMod.ModElement {
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
				...
				int z = (int) entity.posZ;
				{
					...
					ProcedureEderniumStickRightClickedInAir.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setUnlocalizedName("ederniumstick").setRegistryName("ederniumstick").setCreativeTab(TabItemOfWar.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("surgeofwar:ederniumstick", "inventory"));
	}
