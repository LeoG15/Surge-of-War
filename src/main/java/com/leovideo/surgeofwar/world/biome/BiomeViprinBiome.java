...
import com.leovideo.surgeofwar.block.BlockViprinLog;
import com.leovideo.surgeofwar.block.BlockViprinLeaves;
...
public class BiomeViprinBiome extends ElementsSurgeofWar.ModElement {
	...
	static class CustomTree extends WorldGenAbstractTree {
		...
		public boolean generate(World world, Random rand, BlockPos position) {
			...
			if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
				...
				if (!spawnTree) {
					...
					if (!((ground == BlockViprinGrass.block.getDefaultState().getBlock()
							|| ground == BlockViprinDirt.block.getDefaultState().getBlock())
							&& (ground2 == BlockViprinGrass.block.getDefaultState().getBlock()
									|| ground2 == BlockViprinDirt.block.getDefaultState().getBlock())))
						return false;
					IBlockState state = world.getBlockState(position.down());
					if (position.getY() < world.getHeight() - height - 1) {
						world.setBlockState(position.down(), BlockViprinDirt.block.getDefaultState(), 2);
								...
								for (int i2 = position.getZ() - j1; i2 <= position.getZ() + j1; ++i2) {
									...
									if (Math.abs(position.getX()) != j1 || Math.abs(j2) != j1 || rand.nextInt(2) != 0 && i4 != 0) {
										...
										if (state.getBlock().isAir(state, world, blockpos) || state.getBlock().isLeaves(state, world, blockpos)
												...
												|| state.getBlock() == BlockViprinLeaves.block.getDefaultState().getBlock()) {
											this.setBlockAndNotifyAdequately(world, blockpos, BlockViprinLeaves.block.getDefaultState());
										}
									}
								}
							}
						...
						for (int genh = 0; genh < height; genh++) {
							...
							if (state.getBlock().isAir(state, world, genhPos) || state.getBlock() == Blocks.AIR.getDefaultState().getBlock()
									|| state.getBlock() == BlockViprinLeaves.block.getDefaultState().getBlock()) {
								this.setBlockAndNotifyAdequately(world, position.up(genh), BlockViprinLog.block.getDefaultState());
							}
						}
								...
								for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
									if (rand.nextInt(4 - hlevel) == 0) {
										...
										this.setBlockAndNotifyAdequately(world,
												...
												BlockVicoque.block.getDefaultState());
									}
								}
							}
						}
		...
		protected boolean canGrowInto(Block blockType) {
			return blockType.getDefaultState().getMaterial() == Material.AIR || blockType == BlockViprinLog.block.getDefaultState().getBlock()
					|| blockType == BlockViprinLeaves.block.getDefaultState().getBlock()
					|| blockType == BlockViprinGrass.block.getDefaultState().getBlock()
					|| blockType == BlockViprinDirt.block.getDefaultState().getBlock();
		}

		@Override
		protected void setDirtAt(World world, BlockPos pos) {
			if (world.getBlockState(pos).getBlock() != BlockViprinDirt.block.getDefaultState().getBlock())
				this.setBlockAndNotifyAdequately(world, pos, BlockViprinDirt.block.getDefaultState());
		}
