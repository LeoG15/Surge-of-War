...
package com.leovideo.surgeofwar.world;
...
import com.leovideo.surgeofwar.item.ItemGalzan;
import com.leovideo.surgeofwar.block.BlockGalzanDirt;
import com.leovideo.surgeofwar.block.BlockGalzanCandyBlock;
import com.leovideo.surgeofwar.ElementsSurgeofwarMod;

import com.google.common.cache.LoadingCache;

@ElementsSurgeofwarMod.ModElement.Tag
public class WorldGalzan extends ElementsSurgeofwarMod.ModElement {
	public static int DIMID = 5;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("surgeofwar:galzan_portal")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemGalzan().setUnlocalizedName("galzan").setRegistryName("galzan"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension galzan is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("galzan", "_galzan", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemGalzan.block, 0, new ModelResourceLocation("surgeofwar:galzan", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public Vec3d getFogColor(float par1, float par2) {
			return new Vec3d(1, 0.862745098039, 0.721568627451);
		}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag ? BlockGalzanCandyBlock.block.getDefaultState().getBlock().getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
			}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? BlockGalzanCandyBlock.block.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("galzan_portal");
			setRegistryName("galzan_portal");
			setLightLevel(0.3F);
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != BlockGalzanCandyBlock.block.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == BlockGalzanCandyBlock.block.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != BlockGalzanCandyBlock.block.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != BlockGalzanCandyBlock.block
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockGalzanDirt.block.getDefaultState();
		private static final IBlockState STONE2 = BlockGalzanDirt.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("surgeofwar:galzan_biome")),
				Biome.REGISTRY.getObject(new ResourceLocation("surgeofwar:pandora")),};
