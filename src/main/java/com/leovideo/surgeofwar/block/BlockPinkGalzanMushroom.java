...
public class BlockPinkGalzanMushroom extends ElementsSurgeofwarMod.ModElement {
	@GameRegistry.ObjectHolder("surgeofwar:pink_galzan_mushroom")
	public static final Block block = null;
	public BlockPinkGalzanMushroom(ElementsSurgeofwarMod instance) {
		super(instance, 209);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("surgeofwar:pink_galzan_mushroom", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("pink_galzan_mushroom");
			setRegistryName("pink_galzan_mushroom");
		}
