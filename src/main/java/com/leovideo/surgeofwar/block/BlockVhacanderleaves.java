...
public class BlockVhacanderleaves extends ElementsSurgeofWar.ModElement {
	@GameRegistry.ObjectHolder("surgeofwar:vhacanderleaves")
	public static final Block block = null;
	public BlockVhacanderleaves(ElementsSurgeofWar instance) {
		super(instance, 67);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("vhacanderleaves"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("surgeofwar:vhacanderleaves", "inventory"));
		ModelLoader.setCustomStateMapper(block, (new StateMap.Builder()).ignore(BlockLeaves.DECAYABLE, BlockLeaves.CHECK_DECAY).build());
	}
	public static class BlockCustom extends BlockLeaves {
		public BlockCustom() {
			super();
			setUnlocalizedName("vhacanderleaves");
