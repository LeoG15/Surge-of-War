...
import com.leovideo.surgeofwar.procedure.ProcedureCopperSeedFinishPlantRightClicked;
import com.leovideo.surgeofwar.ElementsSurgeofwarMod;

@ElementsSurgeofwarMod.ModElement.Tag
public class BlockCopperSeedFinish extends ElementsSurgeofwarMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("surgeofwar:copperseedfinish", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("copperseedfinish");
			setRegistryName("copperseedfinish");
		}
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction,
			...
			int z = pos.getZ();
			{
				...
				ProcedureCopperSeedFinishPlantRightClicked.executeProcedure($_dependencies);
			}
			return true;
		}
	}
