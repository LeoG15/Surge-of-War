...
public class BlockRedstoneReeds extends ElementsSurgeofWar.ModElement {
	@GameRegistry.ObjectHolder("surgeofwar:redstonereeds")
	public static final Block block = null;
	public BlockRedstoneReeds(ElementsSurgeofWar instance) {
		super(instance, 39);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("surgeofwar:redstonereeds", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("redstonereeds");
			setRegistryName("redstonereeds");
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(Items.REDSTONE, (int) (6)));
		}
